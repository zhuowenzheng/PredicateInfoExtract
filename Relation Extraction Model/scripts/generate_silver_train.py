...
# silver_training (感觉像是最后把之前训练的数据加进去最后进行训练)
sys.path.append("./")
from a2t.legacy.relation_classification.tacred import TACRED_LABELS
from a2t.legacy.relation_classification.utils import apply_threshold, f1_score_

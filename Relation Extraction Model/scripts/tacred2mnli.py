...
# First step (relation verbalization to generate the set of hypotheses:can make it into all kinds of data)
@dataclass
...
parser.add_argument("--output_file", type=str, default="../data/tacred/dev.mini.json")
...
with open(args.input_file, "rt") as f:
    ...
    for line in json.load(f):
        mnli_instance = tacred2mnli(
            # pretrained for all the defined model
            REInputFeatures(
